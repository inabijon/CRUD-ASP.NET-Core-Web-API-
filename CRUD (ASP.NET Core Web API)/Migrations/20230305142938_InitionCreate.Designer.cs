...
namespace CRUD__ASP.NET_Core_Web_API_.Migrations
{
    ...
    [Migration("20230305142938_InitionCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CRUD__ASP.NET_Core_Web_API_.Inspection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CRUD__ASP.NET_Core_Web_API_.InspectionType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CRUD__ASP.NET_Core_Web_API_.Status", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CRUD__ASP.NET_Core_Web_API_.Inspection", b =>
                {
                    b.HasOne("CRUD__ASP.NET_Core_Web_API_.InspectionType", "InspectionType")
                        .WithMany()
